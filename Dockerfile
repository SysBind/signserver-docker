...
RUN mkdir /opt/bitnami/nodb && mv -v /signserver_deploy.properties /opt/bitnami/signserver-ce-5.0.0.Final/conf/signserver_deploy.properties && chown -R 1001 /opt/bitnami/nodb /opt/bitnami/signserver-ce-5.0.0.Final && cd /opt/bitnami/signserver-ce-5.0.0.Final && ./bin/ant deploy
